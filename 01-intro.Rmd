...
```{r weightplot2,echo=FALSE, message=FALSE, warnings=FALSE, fig.cap="Pre- and post-intervention scores on an ineffective diet",out.width="75%"}
...
In the following examples, is there random error, systematic bias, or both?
 ...
 2. Four research assistants measure response times on a naming task. One of the researchers rounds p all measurements to whole seconds, whereas others report to one decimal place **(systematic | random)**  
