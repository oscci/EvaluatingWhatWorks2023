...
```{r weightplot-1,echo=FALSE, include=TRUE,message=FALSE, warnings=FALSE, fig.cap="Random fluctuations in Bridget Jones' weight, measured to the nearest pound",out.width="75%"}
makefig<-0
if(makefig==1){
...
```{r weightplot2,echo=FALSE, message=FALSE, warnings=FALSE, fig.cap="Baseline and outcome measures for an ineffective diet",out.width="75%"}
if(makefig==1){
