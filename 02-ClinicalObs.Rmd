...
```{r rothwellfig, fig.align="center", echo=FALSE, fig.cap="Outcome from surgery in randomized vs non-randomized study, based on Rothwell (2005)",out.height="25%",out.width="25%"}
