...
```{r confoundfig, echo=F,warning=F,message=F,fig.cap="Path diagram showing confounder influence",fig.width=5,fig.height=4,out.width="75%"}
...
```{r rothwellfig, fig.align="center", echo=FALSE, fig.cap="Outcome from surgery in randomized vs non-randomized study, based on Rothwell (2005)",out.height="50%",out.width="50%"}
