...
```{r confoundfig, echo=F,warning=F,message=F,fig.cap="Path diagram showing confounder influence",fig.alt="Triangular arrangement of ovals, labelled Confounder (top), Intervention (left)  and Outcome (right), with arrows showing paths from Confounder to Intervention and Outcome, and dotted arrow showing path from Intervention to Outcome",out.width="50%"}
...
2.  Figure \@ref(fig:rothwellfig) is recreated from a medical example by @rothwell2005, and shows the rate of stroke or death at 5 year follow-up in at-risk patients who either underwent a surgical procedure known as endarterectomy, or who had medical treatment as usual.
...
p2 <- p1+labs(x="Randomized                        Non-randomized", y = "5 year risk (SE) of stroke or death (%)")+
...
```{r rothwellfig, fig.align="center", echo=FALSE, fig.cap="Outcome from surgery in randomized vs non-randomized studies",fig.alt="Bar chart showing 5-year rates of stroke or death in at risk patients who either had surgery or medical treatment as usual",out.height="50%",out.width="50%"}
