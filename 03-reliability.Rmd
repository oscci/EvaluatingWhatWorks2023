...
```{r reliability-by-age,echo=F,include=T,fig.width=6,fig.height=6,fig.cap="Age range can affect reliability",out.width="80%"}
...
```{r ZDensityCDF,echo=F,include=T,fig.cap="Distribution of z-scores, showing proportions of people obtaining scores below -1, between -1 and 1, and above 1",out.width="75%"}
