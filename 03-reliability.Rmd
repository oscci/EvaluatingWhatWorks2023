...
```{r darts, echo=F,  fig.width=8,fig.height=4,fig.cap='Reliability and validity illustrated as a sharpshooter hitting a target',out.width="50%"}
...
```{r correlationfig, echo=F,message=F,warning=F,fig.width=6,fig.height=6,fig.cap="Scatterplots showing relationship between scores at Time 1 and Time 2 for 40 individuals (simulated data).",out.width="80%"}
...
#### Correlation as an index of reliability {.unnumbered}-->
...
```{r reliability-by-age,echo=F,include=T,fig.cap="Scatterplot showing relationship between Time 1 and Time 2 scores for children from two age bands (simulated data).",out.width="85%"}
...
```{r normsplot,echo=F,include=T,fig.cap="Density plot showing distribution of vocabulary scores for three age groups (simulated data). The dotted line shows a raw score of 30, which is above average for 4-year-olds, average for 5-year-olds, and below average for 6-year-olds",out.width="85%"}
#Code to create figures caused problems rendering so removed
...
<!---#### Scaled scores and percentiles {.unnumbered}
NB commas in box headings create mayhem with .tex
::: {#custom}-->

\begin{tcolorbox}[enhanced,breakable,colback=Black!5!lightgray,colframe=black!75!black,coltitle=white,title=Scaled scores and percentiles]\label{box:scaledscores}
...
```{r MLU-plot,echo=FALSE,warning=TRUE,message=TRUE,fig.cap='Mean length of utterance (MLU) values for a cohort of 630 children speaking North American English in the Child Language Data Exchange System archive. Recreated from Ratner and MacWhinney (2016) (data kindly provided by authors)',out.width="85%"}
