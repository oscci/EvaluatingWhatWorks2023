...
```{r placebomake, echo = FALSE, message = FALSE, warning = FALSE}
library(tidyverse)
#need to uncomment and check you have correct version to make figure
...
```{r placebotab, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = 'Placebo effect in a three-arm parallel group trial', fig.alt='Bar chart showing mean outcome for groups with No Treatment, Placebo, and Intervention.The Placebo effect is the difference between Placebo and No treatment means, and the Treatment effect is the difference between Treatment and Placebo groups.', fig.width = 8, fig.height = 5,out.width="75%"}
knitr::include_graphics(paste0('images_bw/placebotab.png'))
