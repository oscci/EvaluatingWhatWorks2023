...
```{r trogfig, echo=F,message=F,warning=F,fig.width=5,fig.height=3.5,fig.cap="Mean comprehension test scores for three groups at baseline and outcome from a study by Bishop et al 2006. Error bars shown standard errors.",out.width="80%"}
myfolder<-'images_bw'
bwversion<-1
