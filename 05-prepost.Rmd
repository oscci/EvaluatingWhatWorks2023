...
```{r trogchangedata,echo=FALSE,message=FALSE,warning=FALSE,fig.cap='TROG data from a study conducted by Bishop et al 2006',fig.width=8,fig.height=4,out.width="75%"}
require(reshape2)
