...
knitr::kable(mini.mat,escape = F, align = "c", booktabs = T,caption = 'Randomised allocation by minimization') %>%
  kable_styling(c("striped", "bordered"), latex_options = "striped", full_width = F) %>%
  column_spec(1, bold = T)%>%
  group_rows("Sex",1,2)%>%
