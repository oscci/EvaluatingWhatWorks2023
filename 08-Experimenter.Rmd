# The reearcher as a source of bias {#experimenter}

`r knitr::include_graphics("images/logo_alone_new.png")`

**Learning objectives**: By the end of this chapter, you will be able to:

-   Explain the concept of experimenter bias, and describe ways in which it can be counteracted
...
```{r phonicsfig, echo=F, fig.cap='Numbers of children with specific scores on phonics screen. (Based on original data from Department for Education website, now deleted)'}
...
```{r rats,echo=F,}
knitr::include_graphics(c("images_bw/ratsx2.png"))
```
