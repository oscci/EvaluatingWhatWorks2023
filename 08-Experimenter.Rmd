...
```{r phonicsfig, echo=F, fig.cap='Numbers of children with specific scores on phonics screen. (Based on original data from Department for Education website, now deleted)',out.width="80%"}
...
<!---#### Another questionable classic study {.unnumbered}
...
\begin{center}
```{r rats,echo=F,out.width="40%"}
knitr::include_graphics("images_bw/ratsx2.png")
```
\end{center}
