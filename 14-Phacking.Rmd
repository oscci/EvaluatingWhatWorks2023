...
\begin{center}
```{r wolfsheepfig, echo=F, fig.cap='Type I and Type II errors',out.width="50%"}
...
2. This [web-based app](https://www.shinyapps.org/apps/p-hacker/) by @schonbrodt2016 allows you to see how easy it can be to get a "significant" result by using flexible analyses. The term DV refers to "dependent variable", i.e. an outcome measure.\
