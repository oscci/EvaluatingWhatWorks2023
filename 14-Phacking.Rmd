...
```{r wolfsheepfig, echo=F,include=T,warning=F,message=F, fig.cap='Type I and Type II errors',out.width="80%"}
...
```{r familywise,echo=F, out.width = "80%",fig.cap="Plot of relationship between familywise error rate and number of statistical tests"}
makefig <-0
if (makefig==1){
k <- seq(1:100)
FWE <- (1-(1-0.05)^k)
