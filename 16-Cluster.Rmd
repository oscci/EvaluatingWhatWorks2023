...
```{r, cluster-diag,echo=FALSE,warning=F,message=F,fig.cap='In the Individual RCT, location is irrelevant and cases are assigned to intervention at random. In the Cluster RCT, there are four geographical clusters, two of which are randomly assigned to each intervention group',out.width="75%"}
  library(ggplot2)
library(ggimage)
library(maptools)
