...
\begin{center}
```{r modfig,echo=F,include=T,warning=F,message=F,fig.cap = "Interaction between intervention effect and Free School Meals status",out.width="95%"}
...
```{r medfig,echo=F,include=T,warning=F,message=F,fig.cap = "Models illustrating mediation vs no mediation in reading intervention study",out.width="85%"}
...
```{r medmodfig,echo=F,include=T,warning=F,message=F,fig.cap = "Path diagram with mediator and moderator",out.width="50%"}
