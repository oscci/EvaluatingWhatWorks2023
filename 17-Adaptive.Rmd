...
```{r adaptiveflow, fig.align="center", fig.height=8,echo=FALSE,out.width="75%",fig.cap="Flow diagram of adaptive trial"}
...
```{r adaptivefig, echo=F, fig.align="center",out.width="90%",fig.cap="Commonly used adaptive designs; based on Thorlund et al, 2018."}
