...
```{r Nitems-power,echo=F,warning=F,message=F,out.width="75%"}
options(kableExtra.html.bsTable = T)
...
```{r ebbelsfig,echo=F,include=T,warning=F,message=F,fig.cap = "Individual results for targets and controls at each term (Redrawn Fig 3 from Leniston & Ebbels, data kindly provided by Susan Ebbels)",out.width="75%"}
