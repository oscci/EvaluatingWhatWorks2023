...
```{r crossoverplot, echo=F, message=F, warning=F, fig.cap="Idealized results from a cross-over RCT",out.width="75%"}
...
```{r waitlist-plot,  echo=F, message=F, warning=F, fig.cap="Idealized results from a waitlist RCT",out.width="80%"}
