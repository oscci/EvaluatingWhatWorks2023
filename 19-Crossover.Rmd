...
\begin{center}
```{r crossoverplot, echo=F, message=F, warning=F, fig.cap="Idealized results from a crossover RCT",out.width="75%"}
...
\begin{center}
```{r waitlist-plot,  echo=F, message=F, warning=F, fig.cap="Idealized results from a waitlist RCT",out.width="75%"}
...
```{r calderfig,  echo=F, message=F, warning=F, fig.cap = "Mean per cent correct in delayed cross-over study by Calder et al, 2021 (data plotted from Calder et al's Table 2).",out.width="60%"}
