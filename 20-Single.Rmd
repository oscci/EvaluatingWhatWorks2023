...
```{r swainfig,echo=F,include=T,warning=F,message=F,fig.cap = "Data from one case in the @swain2020 study. The shaded region shows sessions with intervention for each of the three outcomes.",out.width="60%"}
