...
Table 20.1 in Chapter \@ref(Single) provides a simple framework. There are three basic options when evaluating an intervention:\
...
## How do the results compare with others in the literature?
