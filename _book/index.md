...
## Alternative formats {-}
We hope in future to have options for alternative formats of this book, but to date have not been able to create these. You can, however, make a portable copy of a chapter by typing CTRL+P and selecting either pdf for the output format, or sending the output to a printer. 
